---
title: 'JS로 바닥부터 인공지능을 만들어보자 EP 1 - 개요와 철학'
description: 'This is the first post of my new Astro blog.'
date: '2025-10-27'
status: 'published'
categries: ['DESIGN', 'DEV']
topics: ['DEV']
...
NeuralNetwork-Visualization(이하 NNV) 프로젝트는 인공지능의 기본이 되는 합성곱 신경망을 이용한 숫자 추론을 시각적으로 확인해볼 수 있는 프로젝트입니다. 사용자는 그리드 캔버스에 숫자를 직접 그리고, 이에 real-time으로 반응하는 신경망을 확인할 수 있습니다.

![[2025-11-14 22-35-38(1).gif]]
지금 보시는 화면은 제가 군복무를 하면서 만들었던 인공 신경망 시각화 프로젝트인데요. 프로젝트를 진행하면서 했던 고민과 철학, 겪었던 내용들을 맥락과 함께 자세하게 이야기 해보고자 합니다.

다소 긴 호흡으로 진행될 예정이니 구조와 동작원리만을 설명하는 글은 <u>여기</u>에서 참고하실 수 있습니다.
...
##### 개발을 접하다
 다소 어려운 이야기를 해보았으니 저에 대한 내용도 잠시 언급해보겠습니다. 저는 2022년도 대학교에 입학하며 SSU-IT LOCKER¹ 프로젝트를 통해 소프트웨어 개발을 처음으로 본격적으로 접하게 되었습니다. 그 이전까지는 디자인과 영상 편집 등을 해오며 무언가를 만드는 것에 흥미를 느끼곤 하였는데요. ('사람들의 생각과 감정을 바꿀 수 있는' 이라는 슬로건도 이때 나오게 되었습니다)
...
![[Pasted image 20251116020952.png]]
직관과 비직관의 경계: 어느 손잡이가 어떤 화구를 키는 것일까?
...
![[Pasted image 20251116154924.png]]
합성곱 신경망의 예
출처: http://computing.or.kr/14569/deep-learning%EB%94%A5%EB%9F%AC%EB%8B%9D/
...
이런 식으로 말이죠.
![[2025-11-17 19-31-20 (online-video-cutter.com).gif]]
사용자의 입력을 퍼셉트론에 입력시켜 노드가 변하는 모습
...
¹ SSU-ITLOCKER는 숭실대학교에서 사용하는 교내 사물함 시스템입니다. 소중한 친구인 @EATSTEAKE와 함께 기획/개발 하였습니다.

² ETRI(한국전자통신연구원)의 자료를 근거로 채택하였습니다. 
https://ettrends.etri.re.kr/ettrends/177/0905177011/